...
import com.ecommerce.dao.ShowProductDao;
...
public class ShowProductController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ShowProductDao SP = new ShowProductDao();
		
		try {
			
			ArrayList<Product> arr = SP.getAllproducts(p);
			
			HttpSession session = request.getSession();
			session.setAttribute("AllProduct", arr);
